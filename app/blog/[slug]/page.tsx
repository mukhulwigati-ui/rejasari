          ...
          <div className="flex-1 min-w-0 space-y-4">
            ...
            <main className="w-full border border-gray-200 rounded-xl bg-white shadow-sm space-y-6">
              ...
              <div className="w-full border-t border-gray-150 p-4 md:p-6 space-y-8 bg-white rounded-b-xl">
                ...
                {/* =========================================================
                   SEKSI 3: DAFTAR BERITA TERKINI (PERBAIKAN UKURAN GAMBAR LEBIH BESAR)
                   ========================================================= */}
                    ...
                    {beritaTerkini.map((news, idx) => {
                      ...
                      return (
                        <div key={news.slug || idx} className="flex gap-4 py-4 justify-between items-start group cursor-pointer">
                          ...
                          {/* PERBAIKAN NYATA: Mengubah w-28 h-20 menjadi w-40 h-24 (Ukuran Gambar Lebih Besar & Mantap) */}
